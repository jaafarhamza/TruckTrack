          ...
          <div className="nav-dropdown">
            ...
            {isAdminDropdownOpen && (
              <div className="nav-dropdown-menu">
                ...
                <Link to="/admin/maintenance-rules" className={`nav-dropdown-item ${isActive('/admin/maintenance-rules') ? 'active' : ''}`}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <Link to="/admin/maintenance-alerts" className={`nav-dropdown-item ${isActive('/admin/maintenance-alerts') ? 'active' : ''}`}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
